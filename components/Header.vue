      ...
      <div class="flex justify-between items-center text-center text-xs md:text-lg">
        <div class="flex flex-1 md:flex-none md:gap-6 items-center">
          <h1 class="flex-1 md:flex-none">
            <nuxt-link
              class="flex flex-col md:flex-row gap-1 p-4 md:px-0 items-center md:hover:text-blue-500"
          ...
          <nuxt-link class="flex-1 flex flex-col md:flex-row p-4 md:px-0 gap-1 items-center md:hover:text-blue-500" to="/pages">
            <div class="w-5 h-5 i-con-color"/>
            <span>Browser</span>
          </nuxt-link>
          <nuxt-link class="flex-1 flex flex-col md:flex-row p-4 md:px-0 gap-1 items-center md:hover:text-blue-500" to="/game">
            <div class="w-5 h-5 i-con-gamepad"/>
            <span>Play</span>
          </nuxt-link>
        </div>
        <div class="flex gap-2 items-center">
          <div
            class="btn flex-col gap-1 md:flex-row p-4 md:px-0"
          ...
          <nuxt-link
            class="btn flex-col gap-1 md:flex-row p-4 md:px-0 md:hover:text-blue-500" v-if="userStore.isLogged"

    ...
    <div class="mx-auto max-w-xl w-full font-semibold relative">
      <div class="flex justify-between items-center">
        <div class="flex gap-6 items-center">
          <h1>
            <nuxt-link class="flex gap-1 py-4" title="Play Coloring Logo" to="/">
              <div class="i-con-pad fill-red-400 h-6 w-6"/>
              <img class="hidden md:block w-auto h-6" src="/logo.png" alt="Play Coloring">
            </nuxt-link>
          </h1>
          <nuxt-link class="flex py-4 gap-2 items-center hover:text-blue-500" to="/pages">
        ...
        <div class="flex gap-2 items-center">
          ...
          <nuxt-link v-if="userStore.isLogged" :immediate="true" to="/my-space" title="My space" class="btn py-4 rounded">
